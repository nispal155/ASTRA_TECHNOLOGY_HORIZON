  ...
  return (
    <section id="contact" className="py-24 bg-brand-light-slate border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative group">
        <div className="absolute -inset-1 rounded-[2rem] bg-gradient-to-r from-brand-accent/30 via-amber-400/15 to-brand-accent/30 opacity-20 blur-xl transition-opacity duration-500 pointer-events-none" />
            ...
            {isExpanded && (
              ...
              >
                <div className="flex flex-col border-t border-slate-200">
                  <div className="w-full p-8 md:p-12 lg:p-14 relative bg-white">
                    {isSubmitted ? (
                      ...
                      <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div className="space-y-2">
                            <label htmlFor="company" className="text-sm font-medium text-brand-text">
                        ...
                        <div className="space-y-2">
                          <label htmlFor="subject" className="text-sm font-medium text-brand-text">
                        ...
                        <button
                          ...
                          className="w-full sm:w-auto relative group/btn inline-flex items-center justify-center overflow-hidden bg-brand-accent hover:bg-amber-500 text-white px-8 py-4 rounded-lg font-medium transition-colors disabled:opacity-70 disabled:cursor-not-allowed shadow-md hover:shadow-lg"
                        >
