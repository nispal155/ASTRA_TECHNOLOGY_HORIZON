...
export default function Careers() {
 ...
 return (
 <section id="careers" className="py-24 bg-brand-light-slate border-b border-slate-200 ">
 ...
 className="bg-white border border-slate-200 rounded-3xl p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group"
 >
 <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
 <div>
 <div className="flex flex-wrap items-center gap-3 mb-4">
 <span className="px-3 py-1 bg-brand-light-slate text-brand-primary text-xs font-semibold rounded-full">
 {job.department}
 </span>
 ...
 <a href="#contact" className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-brand-light-bg group-hover:bg-brand-accent text-brand-primary group-hover:text-white transition-all shadow-sm">
