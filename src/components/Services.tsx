...
const SpotlightCard = ({ children, className, delay = 0 }: any) => {
 ...
 className={`relative overflow-hidden group rounded-3xl p-8 md:p-10 border border-brand-light-slate shadow-sm transition-shadow duration-300 ${className}`}
 >
 <div
...
export default function Services() {
 ...
 className: "md:col-span-2 lg:col-span-2 bg-gradient-to-br from-white to-slate-50 ",
 },
 {
 ...
 className: "md:col-span-1 lg:col-span-2 bg-white ",
 },
 {
 ...
 return (
 <section id="services" className="py-24 bg-brand-light-bg border-b border-slate-200 ">
 ...
 className="text-3xl md:text-5xl font-bold text-brand-text mb-6 tracking-tight"
 >
 ...
 >
 <div className="w-14 h-14 rounded-2xl bg-brand-light-slate flex items-center justify-center mb-6 group-hover:bg-brand-accent/20 transition-colors shadow-inner">
 {service.icon}
 </div>
 <h4 className="text-2xl font-bold mb-3 text-brand-text ">
 {service.title}
 </h4>
