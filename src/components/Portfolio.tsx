...
export default function Portfolio() {
 return (
 <section id="portfolio" className="py-24 bg-brand-light-slate ">
 ...
 <div className="text-3xl md:text-5xl font-bold text-brand-text ">
 ...
 <button className="hidden md:flex items-center gap-2 group text-brand-text font-medium hover:text-brand-accent transition-colors">
 View All Projects
 ...
 <button className="inline-flex items-center gap-2 group text-brand-text font-medium hover:text-brand-accent transition-colors">
 View All Projects
 <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
 </button>
 </div>
