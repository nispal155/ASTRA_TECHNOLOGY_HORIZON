    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-brand-primary text-white"
        >
          ...
          >
            <div className="w-24 h-24 sm:w-32 sm:h-32 relative mb-6 rounded-2xl overflow-hidden shadow-[0_0_40px_rgba(255,255,255,0.1)] bg-brand-primary border border-white/10 p-2">
              <Image 
          ...
          <div className="absolute bottom-16 left-1/2 -translate-x-1/2 w-64 h-[2px] bg-white/10 rounded-full overflow-hidden">
            <motion.div
              ...
              className="h-full bg-brand-accent rounded-full shadow-[0_0_10px_rgba(212,137,26,0.8)]"
            />
          </div>
        </motion.div>
      )}
